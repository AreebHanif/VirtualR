            ...
            <div className="container px-4 mx-auto relative text-sm">
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden lg:flex justify-center space-x-12 items-center">
                        ...
                        <a href="#" className='bg-gradient-to-r from-orange-500 to-orange-800 py-2 px-3 border rounded-md'>SignUp</a>
                    </div>
                    <div className='lg:hidden md:flex flex-col justify-end'>
                        <button onClick={toggleMenu}>{!menuOpen ? <Menu /> : <X />}</button>
                    </div>
                </div>
                {menuOpen && (
                    <div className='fixed right-0 z-20 bg-neutral-900 w-full p-12 flex flex-col items-center justify-center lg:hidden'>
                        ...
                        <div className="flex space-x-6">
                            ...
                            <a href="#" className='py-2 px-3 border rounded-md bg-gradient-to-r from-orange-500 to-orange-800 py'>Sign In</a>
                        </div>
                    </div>
                )}
            </div>
